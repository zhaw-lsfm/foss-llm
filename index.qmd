...
::: {.notes}
Emphasize the pattern - this has happened before, multiple times. ArcGIS is especially relevant for IUNR audience. Pause before revealing "Now it's happening with AI" for dramatic effect.
:::
...
::: {.notes}
Transition to the cooking metaphor. Use a casual, conversational tone here - "Let me show you something..."
:::
...
::: {.notes}
Wait for audience reaction - maybe laughter, head shakes. Let them feel the absurdity before moving on.
:::
...
::: {.notes}
The pivot. We DO accept proprietary lock-in for software. Pause here. Let the cognitive dissonance build.
:::
...
::: {.notes}
This is vendor lock-in explained. Once you're invested in their ecosystem, switching becomes prohibitively expensive - not just money, but time, learning, data migration.
:::
...
::: {.notes}
Hands-on validation moment. Expect most hands for ChatGPT, very few for local LLMs. This validates the problem we're addressing. Ask "Why not?" genuinely - you want to understand their barriers.
:::
...
::: {.notes}
This section demystifies LLMs and explains local vs proprietary. Goal is understanding, not technical depth. Keep it practical. Time: 10 minutes.
:::

## What Are LLMs? (Practical Overview)

::: {.notes}
Section divider slide - no need to say much, just let it introduce the topic.
:::
