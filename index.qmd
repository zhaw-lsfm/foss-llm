...
format:
  revealjs:
    ...
    footer: <a href="https://webgis.lsfm.zhaw.ch/foss-llm/">webgis.lsfm.zhaw.ch/foss-llm</a>
revealjs-plugins:
  - attribution
---
...
1. 2 Einheiten Compound-XJ7 hinzufügen.
2. In Pfanne *Model-Pro-2024* bei Einstellung "MEDIUM" erhitzen.
3. Mit zertifiziertem Rührgerät (separat erhältlich) umrühren.
4. Wenn die Kontrollleuchte grün leuchtet, Flavor-Packet-B hinzufügen
...
- Wir kennen keine Betriebssysteme, wir kennen nur *Windows*
- Wir verwenden keine Textverarbeitungsprogramme, wir verwenden *Microsoft Word*
- Wir verwenden keine Messenger, sondern *WhatsApp*

::: {.fragment}
- Werden wir KI nutzen oder werden wir *ChatGPT* verwenden?
:::

::: {.notes}
- Übung: Alle aufstehen.
- Alle hinsetzen, die kein Whatsapp installiert haben
- Wieder aufstehen
- Alle hinsetzen, die kein Telegramm installiert haben
- wieder aufstehen
- Alle hinsetzen, die kein Threema installiert haben
- Alle aufstehen
- Alle hinsetzen, die kein Signal installiert haben
:::

## Die Problematik

Sobald wir genug in ChatGPT investiert haben...

- uns an die Benutzeroberfläche gewöhnt haben
- Unsere Systeme darauf aufgabaut haben
- **Unsere Daten bei ihnen gespeichert haben**
...
[OpenSource in der Cloud]{.shadow}
