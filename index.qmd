...
![Umfrage zur Nutzung von KI bei der Anmeldung an das heutige Webinar](umfrage-sketch.svg){#fig-umfrage}
...
:::{.terminal}
```{.txt}
>>> You are an open-source AI expert. Explain to a group of environmental 
professionals in simple terms what a FOSS LLM is, what benefits it can 
bring to the environmental sector, and what risks they should be aware 
of
```
:::
