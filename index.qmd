...
# Mehr als nur ChatGPT {background-image="images/5790836212_87a89fe3b9_o.jpg" class="blurred-10px strokeme hydepark center" footer=false .nostretch}

[Was Open Source und On Premise KI uns bieten können]{.strokeme}

![Slides: [webgis.lsfm.zhaw.ch/svu-asep-webinar](https://webgis.lsfm.zhaw.ch/svu-asep-webinar)](images/adobe-express-qr-code.svg){width=200}
...
## {background-color="#5F9EA0" visibility="hidden"}
...
Mit folgendem Kommandozeilenbefehl kann man ein Modell initialisieren werden

:::{.terminal}
```{.bash}
# lädt ein kleines, lokales Modell herunter
...
```{.r  filename="analysis.R" code-line-numbers="|2|4-5|7-8|10,15|11|13-14"}
